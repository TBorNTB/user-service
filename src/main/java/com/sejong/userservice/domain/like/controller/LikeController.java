...
//            @RequestHeader("X-User-Id") String username,
        ...
        LikeRes likeRes = likeService.toggleLike(currentUser.getUsername(), postId, postType);
...
//            @RequestHeader("X-User-Id") String username,
        ...
        UserContext currentUser = getCurrentUser();
        LikeRes response = likeService.getLikeStatus(currentUser.getUsername(), postId, postType);
